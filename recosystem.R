...
opts <- recommender$tune(trainMemory, 
                                  opts = list(
                                          dim      = c(60), # number of latent factors    
                                          costp_l2 = c(0.01, 0.1, 0.2), # L2 regularization cost for user factors         
                                          costq_l2 = c(0.01, 0.1, 0.2), # L2 regularization cost for item factors       
